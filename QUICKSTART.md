...
```
┌─────────────────┐      ┌─────────────────┐      ┌─────────────────┐
│   React App     │      │  Express API    │      │ Crownpeak DQM   │
│  (Port 5173)    │─────▶│  (Port 3001)    │─────▶│      API        │
│                 │      │                 │      │                 │
│ - DQMSidebar    │      │ - Auth Routes   │      │ - Analysis      │
│ - Login UI      │      │ - DQM Proxy     │      │ - Highlights    │
│ - HTML Editor   │      │ - Sessions      │      │ - Checkpoints   │
└─────────────────┘      └─────────────────┘      └─────────────────┘
     │                         │
     │ sessionToken            │ apiKey + websiteId
