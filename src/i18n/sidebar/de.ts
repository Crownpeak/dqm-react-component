...
export const sidebar = {
  ...
  ai_backend_local: 'Lokal',
  ai_backend_api: 'API',
  ai_backend_label: 'Übersetzungs-Backend',
  ...
  ai_model_fast: 'Schnell (klein, sehr schnell)',
  ai_model_simple: 'Einfach (sehr klein)',
  ai_model_reliable: 'Zuverlässig (ausgewogen)',
  ai_model_accurate: 'Akkurat (stärker, langsamer)',
  ai_model_configured: 'Von der Host-App vorgegeben',
  ...
  translation_webgpu_required: 'Die Übersetzung erfordert einen WebGPU-fähigen Browser.',
  ...
  summary_api_only: 'Zusammenfassungen nutzen immer ChatGPT (API). Übersetzungen können ChatGPT oder lokal nutzen.',
  ...
  translation_cache: 'Modell-Cache: IndexedDB',
  translation_persistent_storage_on: 'Dauerhafter Speicher: an',
  translation_persistent_storage_off: 'Dauerhafter Speicher: aus',
  translation_persistent_storage_unknown: 'Dauerhafter Speicher: unbekannt',
  translation_request_persistent_storage: 'Modell dauerhaft speichern',
  translation_persistent_storage_explainer: '„Modell dauerhaft speichern" bittet den Browser, den Speicher dieser Website als dauerhaft zu markieren. Dadurch wird er unter Speicherdruck seltener automatisch gelöscht. Nutzer können Website-Daten weiterhin manuell löschen.',
  translation_persistent_storage_denied: 'Der Browser hat dauerhaften Speicher nicht freigegeben. Das ist je nach Browser normal oder passiert, wenn die Website noch wenig genutzt wurde.',
  translation_downloading: 'Modell wird initialisiert…',
