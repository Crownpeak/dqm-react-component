...
export const sidebar = {
  ...
  reasoning_effort: 'Analysetiefe',
  reasoning_effort_hint: 'Bestimmt, wie gründlich GPT-5 Inhalte analysiert (nur für GPT-5 Modelle verfügbar)',
  reasoning_effort_low: 'Schnell',
  reasoning_effort_low_desc: 'Schnelle Antworten, geringere Kosten',
  reasoning_effort_medium: 'Ausgewogen',
  reasoning_effort_medium_desc: 'Gute Qualität und Geschwindigkeit',
  reasoning_effort_high: 'Gründlich',
  reasoning_effort_high_desc: 'Beste Qualität, langsamer',
  gpt5_features: 'GPT-5 Funktionen',
  gpt5_context_window: 'Erweitertes Kontextfenster (1M Tokens)',
