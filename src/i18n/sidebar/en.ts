...
export const sidebar = {
  ...
  reasoning_effort_hint: 'Controls how thoroughly GPT-5 analyzes content (only available for GPT-5 models)',
  reasoning_effort_low: 'Fast',
  reasoning_effort_low_desc: 'Quick responses, lower cost',
  reasoning_effort_medium: 'Balanced',
  reasoning_effort_medium_desc: 'Good quality and speed',
  reasoning_effort_high: 'Thorough',
  reasoning_effort_high_desc: 'Best quality, slower',
  gpt5_features: 'GPT-5 Features',
  gpt5_context_window: 'Extended context window (1M tokens)',
